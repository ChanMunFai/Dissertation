""" Code from https://github.com/charlio23/bouncing-ball/blob/main/generate_data.py"""
...
from data.bouncing_ball import BouncingBall2D
...
if __name__ == "__main__":
    ...
    DEFAULT_DATASETS_ROOT = 'dataset/bouncing_ball/'
