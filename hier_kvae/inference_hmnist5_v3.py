...
class args_1_1:
    subdirectory = "v3/levels=1_factor=1"
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_5/kvae_hier/v3/levels=1/factor=1/kvae_state_dict_scale_89.pth"
...
if __name__ == "__main__": 
    ...
    # plot_predictions_overlap(data, target, 5, args_1_1)
    plot_predictions(data, target, 5, args_1_1)
