# Inference on HealingMNIST_20 for v3 - a_dim = 32, z_dim = 16
...
class args_1_1:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v3/levels=1/factor=1/kvae_state_dict_scale_89.pth"
...
class args_2_1:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v3/levels=2/factor=1/kvae_state_dict_scale_89.pth"
...
class args_2_2:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v3/levels=2/factor=2/kvae_state_dict_scale_89.pth"
...
class args_2_4:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v3/levels=2/factor=4/kvae_state_dict_scale_89.pth"
...
class args_2_6:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v3/levels=2/factor=6/kvae_state_dict_scale_89.pth"
...
class args_3_1:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v3/levels=3/factor=1/kvae_state_dict_scale_89.pth"
...
class args_3_2:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v3/levels=3/factor=2/kvae_state_dict_scale_89.pth"
...
if __name__ == "__main__": 
    ...
    # data, target = load_dataset("HealingMNIST_50", batch_size = 32)
    print(data.shape, target.shape)

    # plot_predictions_overlap(data, target, 20, args_3_1)
    # plot_predictions_diff_colours(data, target, 20, args_3_1)
    # plot_predictions(data, target, 20, args_3_1)
    # plot_reconstructions(data, args_3_1)
