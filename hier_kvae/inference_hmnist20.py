# Separate file for inference on HealingMNIST_20 for easier organisation 
...
class args_2_1:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v1/levels=2/factor=1/kvae_state_dict_scale_89.pth"

class args_1_1_scale_1:
    subdirectory = "levels=1_factor=1_scale=1"
    dataset = "HealingMNIST_20"
    model = 'Hier_KVAE'
    alpha = "rnn"
    lstm_layers = 1
    ...
    device = "cpu"
    scale = 1.0
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v2/levels=1/factor=1/kvae_state_dict_scale_89.pth"
...
class args_2_2:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v1/levels=2/factor=2/kvae_state_dict_scale_89.pth"
...
class args_2_4:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v1/levels=2/factor=4/kvae_state_dict_scale_89.pth"
...
class args_3_1:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v1/levels=3/factor=1/kvae_state_dict_scale_89.pth"
...
class args_3_2:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v1/levels=3/factor=2/kvae_state_dict_scale_89.pth"
...
class args_3_4:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/HealingMNIST_20/kvae_hier/v1/levels=3/factor=4/kvae_state_dict_scale_89.pth"
...
if __name__ == "__main__": 
    ...
    # args_2_2 = args_2_2
    # args_2_4 = args_2_4
    args_1_1_scale_1 =args_1_1_scale_1

    # args_3_1 = args_3_1 
    # args_3_2 = args_3_2
    # args_3_4 = args_3_4 # does not exist 
    
    data, target = load_dataset("HealingMNIST_20", batch_size = 32)
    # data, target = load_dataset("HealingMNIST_5", batch_size = 32)
    print(data.shape, target.shape)

    plot_predictions_overlap(data, target, 20, args_1_1_scale_1)
    plot_predictions_diff_colours(data, target, 20, args_1_1_scale_1)
    plot_predictions(data, target, 20, args_1_1_scale_1)
    plot_reconstructions(data, args_1_1_scale_1)
