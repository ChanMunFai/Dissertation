...
def load_dataset(dataset, batch_size): 
    if dataset == "DancingMNIST_20": 
        train_set = DancingMNISTDataLoader('dataset/DancingMNIST/20/', train = True)
        train_loader = torch.utils.data.DataLoader(
                    dataset=train_set, 
                    batch_size=batch_size, 
                    shuffle=False)

    elif dataset == "DancingMNIST_50": 
        train_set = DancingMNISTDataLoader('dataset/DancingMNIST/50/', train = True, seen_len = 20)
        train_loader = torch.utils.data.DataLoader(
                    dataset=train_set, 
                    batch_size=batch_size, 
                    shuffle=False)
...
class args_1_1:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/DancingMNIST_20/kvae_hier/v1/levels=1/factor=1/kvae_state_dict_scale_89.pth"
...
class args_2_1:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/DancingMNIST_20/kvae_hier/v1/levels=2/factor=1/kvae_state_dict_scale_89.pth"
...
class args_2_2:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/DancingMNIST_20/kvae_hier/v1/levels=2/factor=2/kvae_state_dict_scale_89.pth"
...
class args_2_4:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/DancingMNIST_20/kvae_hier/v1/levels=2/factor=4/kvae_state_dict_scale_89.pth"

class args_2_6:
    subdirectory = "levels=2_factor=6"
    dataset = "DancingMNIST_20"
    model = 'Hier_KVAE'
    alpha = "rnn"
    lstm_layers = 1
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/DancingMNIST_20/kvae_hier/v1/levels=2/factor=6/kvae_state_dict_scale_89.pth"

class args_2_10:
    subdirectory = "levels=2_factor=10"
    dataset = "DancingMNIST_20"
    model = 'Hier_KVAE'
    alpha = "rnn"
    lstm_layers = 1
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/DancingMNIST_20/kvae_hier/v1/levels=2/factor=10/kvae_state_dict_scale_89.pth"
...
class args_3_1:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/DancingMNIST_20/kvae_hier/v5/levels=3/factor=1/kvae_state_dict_scale_89.pth"
...
class args_3_4:
    ...
    device = "cpu"
    scale = 0.3
    state_dict_path = "saves/DancingMNIST_20/kvae_hier/v5/levels=3/factor=4/kvae_state_dict_scale_89.pth"

if __name__ == "__main__": 
    data, target = load_dataset("DancingMNIST_20", batch_size = 32)
    ...
    def plot_mse_dancingmnist20(): 
        ...
        # mse_2_6 = calc_model_losses_over_time(data, target, 20, args_2_6)
        # mse_2_10 = calc_model_losses_over_time(data, target, 20, args_2_10)
        ...
        plt.plot(mse_2_6, label="levels = 2, factor = 6")
        plt.plot(mse_2_10, label="levels = 2, factor = 10")
        ...
        output_dir = f"plots/DancingMNIST_20/KVAE_Hier/"
        if not os.path.isdir(output_dir):
            os.makedirs(output_dir)
        plt.savefig(output_dir + f"KVAE_loss_v2.jpeg")
        plt.close('all')

    def plot_mse_dancingmnist50(): 
        ### MSE over time 
        ...
        # mse_2_6 = calc_model_losses_over_time(data, target, 80, args_2_6)
        # mse_2_10 = calc_model_losses_over_time(data, target, 80, args_2_10)
        ...
        if not os.path.isdir(output_dir):
            os.makedirs(output_dir)
        plt.savefig(output_dir + f"KVAE_loss_80steps_v2.jpeg")
        plt.close('all')

    # plot_mse_dancingmnist20()
    plot_mse_dancingmnist50()
