...
class HealingMNISTDataLoader(Dataset):
...
if __name__ == "__main__": 
    train_dataset = HealingMNISTDataLoader("dataset/HealingMNIST/v2/", train = True)
    ...
    val_dataset = HealingMNISTDataLoader("dataset/HealingMNIST/v2/", train = False)
