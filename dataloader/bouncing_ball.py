...
class BouncingBallDataLoader(Dataset):
    ...
    def __init__(self, root_dir, image = True, transform = None, seen_len = None):
...
def visualize_rollout(rollout, interval=50, show_step=False, save=False):
    ...
    if save:
        ...
        ani.save('dataset/bouncing_ball/bouncing_sequence.gif', writergif)
    plt.show()
...
if __name__ == '__main__':
    ...
    dl = BouncingBallDataLoader('dataset/bouncing_ball/bigger_64/50/train', image = True, transform = True)
    ...
    # visualize_rollout(sample_np[0], interval=50, show_step=False, save=True)
